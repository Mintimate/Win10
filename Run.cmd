    ...
    echo ---------------------------------------------------------------
    echo     脚本支持 Windows 10 系统。如果成功建议捐赠我
    ...
    echo     激活可能一次无法成功，重新运行脚本尝试激活。精简版系统也可能无法激活。
    echo ---------------------------------------------------------------
    echo     脚本不支持路径中带有空格以及中文，请在路径中不含空格的目录下运行。
